...
pdf("Grafico a Barre continent_u_l.pdf")
tabella<- table(dati3$l_continent)
tabella_ord<- tabella[order(tabella, decreasing=T)]
barchart(tabella_ord, ylab = "Frequenza", xlab = "Continente di provenienza dei perdenti (Valori unici)", main = "Grafico a barre continent_u_l", horizontal=F)
dev.off()
